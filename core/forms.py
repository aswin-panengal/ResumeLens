...
class StudentSignUpForm(UserCreationForm):
    ...
    branch = forms.ChoiceField(choices=StudentProfile.BRANCH_CHOICES, widget=forms.Select(attrs={'class': 'form-control'}))
    ...
    def clean_email(self):
        # FIX: Standardize email to lowercase to prevent case-sensitivity login bugs
    ...
    def save(self, commit=True):
        ...
        # Using the cleaned (lowercased) email for both fields
